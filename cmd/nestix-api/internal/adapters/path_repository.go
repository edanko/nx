...
type PathModel struct {
	...
	PathInfo        sql.NullString  `db:"nxpathinfo"`
	MainLength      sql.NullFloat64 `db:"nxmainlength"`
	MainHeight      sql.NullFloat64 `db:"nxmainheight"`
...
func (r *PathRepository) GetByID(ctx context.Context, id int64) (*PathModel, error) {
	tenantID, ok := tenant.FromContext(ctx)
	if !ok {
...
func (r *PathRepository) GetByIDs(ctx context.Context, ids []int64) ([]*PathModel, error) {
	tenantID, ok := tenant.FromContext(ctx)
	if !ok {
		return nil, errors.New("tenant id not found in context")
	}
...
func (r *PathRepository) GetByName(ctx context.Context, name string) (*PathModel, error) {
	tenantID, ok := tenant.FromContext(ctx)
	if !ok {
		return nil, errors.New("tenant id not found in context")
	}
...
func (r *PathRepository) List(ctx context.Context) ([]*PathModel, error) {
	tenantID, ok := tenant.FromContext(ctx)
	if !ok {
		return nil, errors.New("tenant id not found in context")
	}
...
func (r *PathRepository) SearchByName(ctx context.Context, name string) ([]*PathModel, error) {
	tenantID, ok := tenant.FromContext(ctx)
	if !ok {
		return nil, errors.New("tenant id not found in context")
	}
