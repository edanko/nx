...
import (
	...
	proto "github.com/edanko/nx/pkg/genproto/launch/v1"
)
...
func (g GrpcServer) ChangeKindDescription(
	...
	err = g.app.Commands.Send(ctx, commands.ChangeKindDescription{
		ID:          id,
...
func (g GrpcServer) ChangeKindName(
	...
	err = g.app.Commands.Send(ctx, commands.ChangeKindName{
		ID:   id,
		Name: request.Name,
	})
...
func (g GrpcServer) CreateKind(
	...
	err := g.app.Commands.Send(ctx, commands.CreateKind{
		ID:          uuid.New(),
		Name:        request.Name,
		Description: request.Description,
		Status:      request.Status,
...
func (g GrpcServer) DeleteKind(
	...
	err = g.app.Commands.Send(ctx, commands.DeleteKind{
		ID: id,
	})
...
func (g GrpcServer) MakeKindDraft(
	...
	err = g.app.Commands.Send(ctx, commands.MakeKindDraft{
		ID: id,
	})
...
func (g GrpcServer) MakeKindPublished(
	...
	err = g.app.Commands.Send(ctx, commands.MakeKindPublished{
		ID: id,
	})
